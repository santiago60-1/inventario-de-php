...
<body>
    ...
    <main>
        <h1>Formulario para actualizar producto</h1>
        ...
        <form action="/productos/actualizar" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" value="Nombre actual" placeholder="Ingresa el nombre" required>
            </div>

            <div class="form-group">
                <label for="descripcion">Descripción:</label>
                <textarea id="descripcion" name="descripcion" rows="4" placeholder="Describe el producto">Descripción actual</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="cantidad" name="cantidad" min="0" value="0" placeholder="0" required>
            </div>
