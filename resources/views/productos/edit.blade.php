        ...
        <form action="{{ route('productos.update', $producto->id) }}"
            ...
            <div>
                ...
                <textarea id="descripcion"
                          ...
                          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent">{{ $producto->descripcion }}</textarea>
            </div>
